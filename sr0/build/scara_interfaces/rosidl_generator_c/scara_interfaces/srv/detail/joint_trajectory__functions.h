...
#ifndef SCARA_INTERFACES__SRV__DETAIL__JOINT_TRAJECTORY__FUNCTIONS_H_
#define SCARA_INTERFACES__SRV__DETAIL__JOINT_TRAJECTORY__FUNCTIONS_H_
 ...
 * calls
 * scara_interfaces__srv__JointTrajectory_Request__init().
...
/**
 * It calls
 * scara_interfaces__srv__JointTrajectory_Request__fini()
 ...
 * scara_interfaces__srv__JointTrajectory_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * scara_interfaces__srv__JointTrajectory_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * scara_interfaces__srv__JointTrajectory_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_scara_interfaces
...
/**
 * It calls
 * scara_interfaces__srv__JointTrajectory_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_scara_interfaces
...
/**
 * It allocates the memory for the array and calls
 * scara_interfaces__srv__JointTrajectory_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_scara_interfaces
...
/**
 * It calls
 * scara_interfaces__srv__JointTrajectory_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SCARA_INTERFACES__SRV__DETAIL__JOINT_TRAJECTORY__FUNCTIONS_H_
