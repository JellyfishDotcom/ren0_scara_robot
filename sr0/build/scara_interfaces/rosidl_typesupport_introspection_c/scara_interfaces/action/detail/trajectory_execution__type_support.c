...
#include <stddef.h>
#include "scara_interfaces/action/detail/trajectory_execution__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  scara_interfaces__action__TrajectoryExecution_Goal__init(message_memory);
}
...
{
  scara_interfaces__action__TrajectoryExecution_Goal__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember TrajectoryExecution_Goal__rosidl_typesupport_introspection_c__TrajectoryExecution_Goal_message_member_array[1] = {
  {
    ...
    offsetof(scara_interfaces__action__TrajectoryExecution_Goal, trajectory),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers TrajectoryExecution_Goal__rosidl_typesupport_introspection_c__TrajectoryExecution_Goal_message_members = {
  "scara_interfaces__action",  // message namespace
  "TrajectoryExecution_Goal",  // message name
  1,  // number of fields
  sizeof(scara_interfaces__action__TrajectoryExecution_Goal),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, action, TrajectoryExecution_Goal)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  scara_interfaces__action__TrajectoryExecution_Result__init(message_memory);
}
...
{
  scara_interfaces__action__TrajectoryExecution_Result__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember TrajectoryExecution_Result__rosidl_typesupport_introspection_c__TrajectoryExecution_Result_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(scara_interfaces__action__TrajectoryExecution_Result, final_point),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TrajectoryExecution_Result__rosidl_typesupport_introspection_c__TrajectoryExecution_Result_message_members = {
  ...
  1,  // number of fields
  sizeof(scara_interfaces__action__TrajectoryExecution_Result),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_scara_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, action, TrajectoryExecution_Result)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  scara_interfaces__action__TrajectoryExecution_Feedback__init(message_memory);
}
...
{
  scara_interfaces__action__TrajectoryExecution_Feedback__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember TrajectoryExecution_Feedback__rosidl_typesupport_introspection_c__TrajectoryExecution_Feedback_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(scara_interfaces__action__TrajectoryExecution_Feedback, actual_point),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TrajectoryExecution_Feedback__rosidl_typesupport_introspection_c__TrajectoryExecution_Feedback_message_members = {
  ...
  1,  // number of fields
  sizeof(scara_interfaces__action__TrajectoryExecution_Feedback),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_scara_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, action, TrajectoryExecution_Feedback)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  scara_interfaces__action__TrajectoryExecution_SendGoal_Request__init(message_memory);
}
...
{
  scara_interfaces__action__TrajectoryExecution_SendGoal_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember TrajectoryExecution_SendGoal_Request__rosidl_typesupport_introspection_c__TrajectoryExecution_SendGoal_Request_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(scara_interfaces__action__TrajectoryExecution_SendGoal_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(scara_interfaces__action__TrajectoryExecution_SendGoal_Request, goal),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TrajectoryExecution_SendGoal_Request__rosidl_typesupport_introspection_c__TrajectoryExecution_SendGoal_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(scara_interfaces__action__TrajectoryExecution_SendGoal_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_scara_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, action, TrajectoryExecution_SendGoal_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  scara_interfaces__action__TrajectoryExecution_SendGoal_Response__init(message_memory);
}
...
{
  scara_interfaces__action__TrajectoryExecution_SendGoal_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember TrajectoryExecution_SendGoal_Response__rosidl_typesupport_introspection_c__TrajectoryExecution_SendGoal_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(scara_interfaces__action__TrajectoryExecution_SendGoal_Response, accepted),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(scara_interfaces__action__TrajectoryExecution_SendGoal_Response, stamp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TrajectoryExecution_SendGoal_Response__rosidl_typesupport_introspection_c__TrajectoryExecution_SendGoal_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(scara_interfaces__action__TrajectoryExecution_SendGoal_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_scara_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, action, TrajectoryExecution_SendGoal_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_SendGoal_service_members = {
  "scara_interfaces__action",  // service namespace
  "TrajectoryExecution_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_SendGoal_service_type_support_handle = {
  0,
  &scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, action, TrajectoryExecution_SendGoal)() {
  if (!scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_SendGoal_service_type_support_handle.typesupport_identifier) {
    scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_SendGoal_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, action, TrajectoryExecution_SendGoal_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, action, TrajectoryExecution_SendGoal_Response)()->data;
  }

  return &scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_SendGoal_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  scara_interfaces__action__TrajectoryExecution_GetResult_Request__init(message_memory);
}
...
{
  scara_interfaces__action__TrajectoryExecution_GetResult_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember TrajectoryExecution_GetResult_Request__rosidl_typesupport_introspection_c__TrajectoryExecution_GetResult_Request_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(scara_interfaces__action__TrajectoryExecution_GetResult_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TrajectoryExecution_GetResult_Request__rosidl_typesupport_introspection_c__TrajectoryExecution_GetResult_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(scara_interfaces__action__TrajectoryExecution_GetResult_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_scara_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, action, TrajectoryExecution_GetResult_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  scara_interfaces__action__TrajectoryExecution_GetResult_Response__init(message_memory);
}
...
{
  scara_interfaces__action__TrajectoryExecution_GetResult_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember TrajectoryExecution_GetResult_Response__rosidl_typesupport_introspection_c__TrajectoryExecution_GetResult_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(scara_interfaces__action__TrajectoryExecution_GetResult_Response, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(scara_interfaces__action__TrajectoryExecution_GetResult_Response, result),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TrajectoryExecution_GetResult_Response__rosidl_typesupport_introspection_c__TrajectoryExecution_GetResult_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(scara_interfaces__action__TrajectoryExecution_GetResult_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_scara_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, action, TrajectoryExecution_GetResult_Response)() {
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_GetResult_service_members = {
  "scara_interfaces__action",  // service namespace
  "TrajectoryExecution_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_GetResult_service_type_support_handle = {
  0,
  &scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_scara_interfaces
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, action, TrajectoryExecution_GetResult)() {
  if (!scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_GetResult_service_type_support_handle.typesupport_identifier) {
    scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_GetResult_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, action, TrajectoryExecution_GetResult_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, action, TrajectoryExecution_GetResult_Response)()->data;
  }

  return &scara_interfaces__action__detail__trajectory_execution__rosidl_typesupport_introspection_c__TrajectoryExecution_GetResult_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  scara_interfaces__action__TrajectoryExecution_FeedbackMessage__init(message_memory);
}
...
{
  scara_interfaces__action__TrajectoryExecution_FeedbackMessage__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember TrajectoryExecution_FeedbackMessage__rosidl_typesupport_introspection_c__TrajectoryExecution_FeedbackMessage_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(scara_interfaces__action__TrajectoryExecution_FeedbackMessage, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(scara_interfaces__action__TrajectoryExecution_FeedbackMessage, feedback),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TrajectoryExecution_FeedbackMessage__rosidl_typesupport_introspection_c__TrajectoryExecution_FeedbackMessage_message_members = {
  ...
  2,  // number of fields
  sizeof(scara_interfaces__action__TrajectoryExecution_FeedbackMessage),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_scara_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, action, TrajectoryExecution_FeedbackMessage)() {
