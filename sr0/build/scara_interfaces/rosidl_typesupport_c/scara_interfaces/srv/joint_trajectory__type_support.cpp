...
static const _JointTrajectory_Request_type_support_symbol_names_t _JointTrajectory_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, scara_interfaces, srv, JointTrajectory_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, srv, JointTrajectory_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, scara_interfaces, srv, JointTrajectory_Request)() {
  return &::scara_interfaces::srv::rosidl_typesupport_c::JointTrajectory_Request_message_type_support_handle;
}
...
static const _JointTrajectory_Response_type_support_symbol_names_t _JointTrajectory_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, scara_interfaces, srv, JointTrajectory_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, srv, JointTrajectory_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_scara_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, scara_interfaces, srv, JointTrajectory_Response)() {
  return &::scara_interfaces::srv::rosidl_typesupport_c::JointTrajectory_Response_message_type_support_handle;
}
...
static const _JointTrajectory_type_support_symbol_names_t _JointTrajectory_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, scara_interfaces, srv, JointTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scara_interfaces, srv, JointTrajectory)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, scara_interfaces, srv, JointTrajectory)() {
  return &::scara_interfaces::srv::rosidl_typesupport_c::JointTrajectory_service_type_support_handle;
}
