...
class TrajectoryExecution_SendGoal_Request(metaclass=Metaclass_TrajectoryExecution_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'scara_interfaces/TrajectoryExecution_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['scara_interfaces', 'action'], 'TrajectoryExecution_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from scara_interfaces.action._trajectory_execution import TrajectoryExecution_Goal
...
class Metaclass_TrajectoryExecution_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'scara_interfaces.action.TrajectoryExecution_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from scara_interfaces.action import _trajectory_execution
...
class TrajectoryExecution_SendGoal(metaclass=Metaclass_TrajectoryExecution_SendGoal):
    from scara_interfaces.action._trajectory_execution import TrajectoryExecution_SendGoal_Request as Request
    from scara_interfaces.action._trajectory_execution import TrajectoryExecution_SendGoal_Response as Response
...
class TrajectoryExecution_GetResult_Response(metaclass=Metaclass_TrajectoryExecution_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'scara_interfaces/TrajectoryExecution_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['scara_interfaces', 'action'], 'TrajectoryExecution_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from scara_interfaces.action._trajectory_execution import TrajectoryExecution_Result
...
class Metaclass_TrajectoryExecution_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'scara_interfaces.action.TrajectoryExecution_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class TrajectoryExecution_GetResult(metaclass=Metaclass_TrajectoryExecution_GetResult):
    from scara_interfaces.action._trajectory_execution import TrajectoryExecution_GetResult_Request as Request
    from scara_interfaces.action._trajectory_execution import TrajectoryExecution_GetResult_Response as Response
...
class Metaclass_TrajectoryExecution_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'scara_interfaces.action.TrajectoryExecution_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class TrajectoryExecution_FeedbackMessage(metaclass=Metaclass_TrajectoryExecution_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'scara_interfaces/TrajectoryExecution_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['scara_interfaces', 'action'], 'TrajectoryExecution_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from scara_interfaces.action._trajectory_execution import TrajectoryExecution_Feedback
...
class Metaclass_TrajectoryExecution(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'scara_interfaces.action.TrajectoryExecution')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class TrajectoryExecution(metaclass=Metaclass_TrajectoryExecution):
    ...
    from scara_interfaces.action._trajectory_execution import TrajectoryExecution_Goal as Goal
    # The result message defined in the action definition.
    from scara_interfaces.action._trajectory_execution import TrajectoryExecution_Result as Result
    # The feedback message defined in the action definition.
    from scara_interfaces.action._trajectory_execution import TrajectoryExecution_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from scara_interfaces.action._trajectory_execution import TrajectoryExecution_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from scara_interfaces.action._trajectory_execution import TrajectoryExecution_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from scara_interfaces.action._trajectory_execution import TrajectoryExecution_FeedbackMessage as FeedbackMessage
