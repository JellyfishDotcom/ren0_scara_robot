...
#include "scara_interfaces/srv/detail/joint_trajectory__rosidl_typesupport_fastrtps_c.h"
...
using _JointTrajectory_Request__ros_msg_type = scara_interfaces__srv__JointTrajectory_Request;
...
size_t get_serialized_size_scara_interfaces__srv__JointTrajectory_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JointTrajectory_Request__ros_msg_type * ros_message = static_cast<const _JointTrajectory_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _JointTrajectory_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_scara_interfaces__srv__JointTrajectory_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_scara_interfaces
size_t max_serialized_size_scara_interfaces__srv__JointTrajectory_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_scara_interfaces__srv__JointTrajectory_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, scara_interfaces, srv, JointTrajectory_Request)() {
...
using _JointTrajectory_Response__ros_msg_type = scara_interfaces__srv__JointTrajectory_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_scara_interfaces
size_t get_serialized_size_scara_interfaces__srv__JointTrajectory_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JointTrajectory_Response__ros_msg_type * ros_message = static_cast<const _JointTrajectory_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_scara_interfaces__srv__JointTrajectory_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_scara_interfaces
size_t max_serialized_size_scara_interfaces__srv__JointTrajectory_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_scara_interfaces__srv__JointTrajectory_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, scara_interfaces, srv, JointTrajectory_Response)() {
...
// already included above
// #include "scara_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "scara_interfaces/srv/joint_trajectory.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, scara_interfaces, srv, JointTrajectory)() {
