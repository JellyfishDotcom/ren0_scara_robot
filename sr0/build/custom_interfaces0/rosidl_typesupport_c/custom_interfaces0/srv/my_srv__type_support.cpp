...
static const _MySrv_Request_type_support_symbol_names_t _MySrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, srv, MySrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces0, srv, MySrv_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_interfaces0, srv, MySrv_Request)() {
  return &::custom_interfaces0::srv::rosidl_typesupport_c::MySrv_Request_message_type_support_handle;
}
...
static const _MySrv_Response_type_support_symbol_names_t _MySrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, srv, MySrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces0, srv, MySrv_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_custom_interfaces0
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_interfaces0, srv, MySrv_Response)() {
  return &::custom_interfaces0::srv::rosidl_typesupport_c::MySrv_Response_message_type_support_handle;
}
...
static const _MySrv_type_support_symbol_names_t _MySrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, srv, MySrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces0, srv, MySrv)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, custom_interfaces0, srv, MySrv)() {
  return &::custom_interfaces0::srv::rosidl_typesupport_c::MySrv_service_type_support_handle;
}
