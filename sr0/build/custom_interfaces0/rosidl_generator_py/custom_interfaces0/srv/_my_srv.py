...
class Metaclass_MySrv(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from custom_interfaces0.srv import _my_srv
...
class MySrv(metaclass=Metaclass_MySrv):
    from custom_interfaces0.srv._my_srv import MySrv_Request as Request
    from custom_interfaces0.srv._my_srv import MySrv_Response as Response
