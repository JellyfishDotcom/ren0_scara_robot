...
#include "custom_interfaces0/srv/detail/my_srv__rosidl_typesupport_fastrtps_c.h"
...
using _MySrv_Request__ros_msg_type = custom_interfaces0__srv__MySrv_Request;
...
size_t get_serialized_size_custom_interfaces0__srv__MySrv_Request(
  const void * untyped_ros_message,
...
static uint32_t _MySrv_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces0__srv__MySrv_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t max_serialized_size_custom_interfaces0__srv__MySrv_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_custom_interfaces0__srv__MySrv_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, srv, MySrv_Request)() {
...
using _MySrv_Response__ros_msg_type = custom_interfaces0__srv__MySrv_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t get_serialized_size_custom_interfaces0__srv__MySrv_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MySrv_Response__ros_msg_type * ros_message = static_cast<const _MySrv_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces0__srv__MySrv_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t max_serialized_size_custom_interfaces0__srv__MySrv_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_custom_interfaces0__srv__MySrv_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, srv, MySrv_Response)() {
...
// already included above
// #include "custom_interfaces0/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "custom_interfaces0/srv/my_srv.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, srv, MySrv)() {
