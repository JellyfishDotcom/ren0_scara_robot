...
#include "custom_interfaces0/action/detail/myaction__rosidl_typesupport_fastrtps_c.h"
...
#include "custom_interfaces0/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Myaction_Goal__ros_msg_type = custom_interfaces0__action__Myaction_Goal;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 3;
    auto array_ptr = ros_message->goal_position;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t get_serialized_size_custom_interfaces0__action__Myaction_Goal(
  const void * untyped_ros_message,
...
static uint32_t _Myaction_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces0__action__Myaction_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t max_serialized_size_custom_interfaces0__action__Myaction_Goal(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _Myaction_Goal__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_custom_interfaces0__action__Myaction_Goal(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_Myaction_Goal = {
  "custom_interfaces0::action",
  "Myaction_Goal",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, action, Myaction_Goal)() {
...
using _Myaction_Result__ros_msg_type = custom_interfaces0__action__Myaction_Result;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result_position
  {
    size_t size = 3;
    auto array_ptr = ros_message->result_position;
    cdr.serializeArray(array_ptr, size);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t get_serialized_size_custom_interfaces0__action__Myaction_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Myaction_Result__ros_msg_type * ros_message = static_cast<const _Myaction_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces0__action__Myaction_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t max_serialized_size_custom_interfaces0__action__Myaction_Result(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _Myaction_Result__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_custom_interfaces0__action__Myaction_Result(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, action, Myaction_Result)() {
...
using _Myaction_Feedback__ros_msg_type = custom_interfaces0__action__Myaction_Feedback;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 3;
    auto array_ptr = ros_message->current_position;
    cdr.serializeArray(array_ptr, size);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t get_serialized_size_custom_interfaces0__action__Myaction_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Myaction_Feedback__ros_msg_type * ros_message = static_cast<const _Myaction_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces0__action__Myaction_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t max_serialized_size_custom_interfaces0__action__Myaction_Feedback(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _Myaction_Feedback__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_custom_interfaces0__action__Myaction_Feedback(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, action, Myaction_Feedback)() {
...
// already included above
// #include "custom_interfaces0/action/detail/myaction__functions.h"  // goal
...
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, action, Myaction_Goal)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_custom_interfaces0
...
using _Myaction_SendGoal_Request__ros_msg_type = custom_interfaces0__action__Myaction_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_interfaces0, action, Myaction_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t get_serialized_size_custom_interfaces0__action__Myaction_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Myaction_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _Myaction_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_custom_interfaces0__action__Myaction_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces0__action__Myaction_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t max_serialized_size_custom_interfaces0__action__Myaction_SendGoal_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_custom_interfaces0__action__Myaction_Goal(
        full_bounded, current_alignment);
    }
  }
...
static size_t _Myaction_SendGoal_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_custom_interfaces0__action__Myaction_SendGoal_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, action, Myaction_SendGoal_Request)() {
...
using _Myaction_SendGoal_Response__ros_msg_type = custom_interfaces0__action__Myaction_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t get_serialized_size_custom_interfaces0__action__Myaction_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Myaction_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _Myaction_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces0__action__Myaction_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t max_serialized_size_custom_interfaces0__action__Myaction_SendGoal_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _Myaction_SendGoal_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_custom_interfaces0__action__Myaction_SendGoal_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, action, Myaction_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, action, Myaction_SendGoal)() {
...
using _Myaction_GetResult_Request__ros_msg_type = custom_interfaces0__action__Myaction_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t get_serialized_size_custom_interfaces0__action__Myaction_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Myaction_GetResult_Request__ros_msg_type * ros_message = static_cast<const _Myaction_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces0__action__Myaction_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t max_serialized_size_custom_interfaces0__action__Myaction_GetResult_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _Myaction_GetResult_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_custom_interfaces0__action__Myaction_GetResult_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, action, Myaction_GetResult_Request)() {
...
// already included above
// #include "custom_interfaces0/action/detail/myaction__functions.h"  // result
...
using _Myaction_GetResult_Response__ros_msg_type = custom_interfaces0__action__Myaction_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_interfaces0, action, Myaction_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t get_serialized_size_custom_interfaces0__action__Myaction_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Myaction_GetResult_Response__ros_msg_type * ros_message = static_cast<const _Myaction_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_custom_interfaces0__action__Myaction_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces0__action__Myaction_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t max_serialized_size_custom_interfaces0__action__Myaction_GetResult_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_custom_interfaces0__action__Myaction_Result(
        full_bounded, current_alignment);
    }
  }
...
static size_t _Myaction_GetResult_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_custom_interfaces0__action__Myaction_GetResult_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, action, Myaction_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, action, Myaction_GetResult)() {
...
// already included above
// #include "custom_interfaces0/action/detail/myaction__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Myaction_FeedbackMessage__ros_msg_type = custom_interfaces0__action__Myaction_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_interfaces0, action, Myaction_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t get_serialized_size_custom_interfaces0__action__Myaction_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Myaction_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _Myaction_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_custom_interfaces0__action__Myaction_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces0__action__Myaction_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces0
size_t max_serialized_size_custom_interfaces0__action__Myaction_FeedbackMessage(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_custom_interfaces0__action__Myaction_Feedback(
        full_bounded, current_alignment);
    }
  }
...
static size_t _Myaction_FeedbackMessage__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_custom_interfaces0__action__Myaction_FeedbackMessage(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces0, action, Myaction_FeedbackMessage)() {
