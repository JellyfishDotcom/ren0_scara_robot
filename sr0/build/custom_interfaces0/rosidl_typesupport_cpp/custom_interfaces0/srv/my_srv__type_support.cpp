...
static const _MySrv_Request_type_support_symbol_names_t _MySrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces0, srv, MySrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces0, srv, MySrv_Request)),
  }
};
...
{
  return &::custom_interfaces0::srv::rosidl_typesupport_cpp::MySrv_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_interfaces0, srv, MySrv_Request)() {
  return get_message_type_support_handle<custom_interfaces0::srv::MySrv_Request>();
}
...
static const _MySrv_Response_type_support_symbol_names_t _MySrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces0, srv, MySrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces0, srv, MySrv_Response)),
  }
};
...
{
  return &::custom_interfaces0::srv::rosidl_typesupport_cpp::MySrv_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_interfaces0, srv, MySrv_Response)() {
  return get_message_type_support_handle<custom_interfaces0::srv::MySrv_Response>();
}
...
static const _MySrv_type_support_symbol_names_t _MySrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces0, srv, MySrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces0, srv, MySrv)),
  }
};
...
{
  return &::custom_interfaces0::srv::rosidl_typesupport_cpp::MySrv_service_type_support_handle;
}
