...
{
  new (message_memory) reno_interface::srv::JointTrajectory_Request(_init);
}

void JointTrajectory_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<reno_interface::srv::JointTrajectory_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointTrajectory_Request_message_member_array[2] = {
  {
    ...
    offsetof(reno_interface::srv::JointTrajectory_Request, initial_point),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(reno_interface::srv::JointTrajectory_Request, final_point),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JointTrajectory_Request_message_members = {
  "reno_interface::srv",  // message namespace
  "JointTrajectory_Request",  // message name
  2,  // number of fields
  sizeof(reno_interface::srv::JointTrajectory_Request),
...
{
  return &::reno_interface::srv::rosidl_typesupport_introspection_cpp::JointTrajectory_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, reno_interface, srv, JointTrajectory_Request)() {
  return &::reno_interface::srv::rosidl_typesupport_introspection_cpp::JointTrajectory_Request_message_type_support_handle;
}
...
void JointTrajectory_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) reno_interface::srv::JointTrajectory_Response(_init);
}

void JointTrajectory_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<reno_interface::srv::JointTrajectory_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointTrajectory_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(reno_interface::srv::JointTrajectory_Response, trajectory),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JointTrajectory_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(reno_interface::srv::JointTrajectory_Response),
...
{
  return &::reno_interface::srv::rosidl_typesupport_introspection_cpp::JointTrajectory_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, reno_interface, srv, JointTrajectory_Response)() {
  return &::reno_interface::srv::rosidl_typesupport_introspection_cpp::JointTrajectory_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers JointTrajectory_service_members = {
  "reno_interface::srv",  // service namespace
  "JointTrajectory",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<reno_interface::srv::JointTrajectory>()
...
get_service_type_support_handle<reno_interface::srv::JointTrajectory>()
{
  ...
  auto service_type_support =
    &::reno_interface::srv::rosidl_typesupport_introspection_cpp::JointTrajectory_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::reno_interface::srv::JointTrajectory_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::reno_interface::srv::JointTrajectory_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, reno_interface, srv, JointTrajectory)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<reno_interface::srv::JointTrajectory>();
}
