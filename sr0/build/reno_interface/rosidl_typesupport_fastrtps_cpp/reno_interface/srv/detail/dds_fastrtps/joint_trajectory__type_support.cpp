...
#include "reno_interface/srv/detail/joint_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const reno_interface::srv::JointTrajectory_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<reno_interface::srv::JointTrajectory_Request *>(
    untyped_ros_message);
...
{
  return &reno_interface::srv::typesupport_fastrtps_cpp::_JointTrajectory_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const reno_interface::srv::JointTrajectory_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<reno_interface::srv::JointTrajectory_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &reno_interface::srv::typesupport_fastrtps_cpp::_JointTrajectory_Response__handle;
}
...
{
  return &reno_interface::srv::typesupport_fastrtps_cpp::_JointTrajectory__handle;
}
