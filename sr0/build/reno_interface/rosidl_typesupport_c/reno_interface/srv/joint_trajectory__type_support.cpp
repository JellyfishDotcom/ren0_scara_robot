...
static const _JointTrajectory_Request_type_support_symbol_names_t _JointTrajectory_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, reno_interface, srv, JointTrajectory_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, reno_interface, srv, JointTrajectory_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, reno_interface, srv, JointTrajectory_Request)() {
  return &::reno_interface::srv::rosidl_typesupport_c::JointTrajectory_Request_message_type_support_handle;
}
...
static const _JointTrajectory_Response_type_support_symbol_names_t _JointTrajectory_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, reno_interface, srv, JointTrajectory_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, reno_interface, srv, JointTrajectory_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_reno_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, reno_interface, srv, JointTrajectory_Response)() {
  return &::reno_interface::srv::rosidl_typesupport_c::JointTrajectory_Response_message_type_support_handle;
}
...
static const _JointTrajectory_type_support_symbol_names_t _JointTrajectory_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, reno_interface, srv, JointTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, reno_interface, srv, JointTrajectory)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, reno_interface, srv, JointTrajectory)() {
  return &::reno_interface::srv::rosidl_typesupport_c::JointTrajectory_service_type_support_handle;
}
