...
#include <stddef.h>
#include "reno_interface/srv/detail/joint_trajectory__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  reno_interface__srv__JointTrajectory_Request__init(message_memory);
}
...
{
  reno_interface__srv__JointTrajectory_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember JointTrajectory_Request__rosidl_typesupport_introspection_c__JointTrajectory_Request_message_member_array[2] = {
  {
    ...
    offsetof(reno_interface__srv__JointTrajectory_Request, initial_point),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(reno_interface__srv__JointTrajectory_Request, final_point),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers JointTrajectory_Request__rosidl_typesupport_introspection_c__JointTrajectory_Request_message_members = {
  "reno_interface__srv",  // message namespace
  "JointTrajectory_Request",  // message name
  2,  // number of fields
  sizeof(reno_interface__srv__JointTrajectory_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, reno_interface, srv, JointTrajectory_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  reno_interface__srv__JointTrajectory_Response__init(message_memory);
}
...
{
  reno_interface__srv__JointTrajectory_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember JointTrajectory_Response__rosidl_typesupport_introspection_c__JointTrajectory_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(reno_interface__srv__JointTrajectory_Response, trajectory),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers JointTrajectory_Response__rosidl_typesupport_introspection_c__JointTrajectory_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(reno_interface__srv__JointTrajectory_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_reno_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, reno_interface, srv, JointTrajectory_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers reno_interface__srv__detail__joint_trajectory__rosidl_typesupport_introspection_c__JointTrajectory_service_members = {
  "reno_interface__srv",  // service namespace
  "JointTrajectory",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // reno_interface__srv__detail__joint_trajectory__rosidl_typesupport_introspection_c__JointTrajectory_Request_message_type_support_handle,
  NULL  // response message
  // reno_interface__srv__detail__joint_trajectory__rosidl_typesupport_introspection_c__JointTrajectory_Response_message_type_support_handle
};

static rosidl_service_type_support_t reno_interface__srv__detail__joint_trajectory__rosidl_typesupport_introspection_c__JointTrajectory_service_type_support_handle = {
  0,
  &reno_interface__srv__detail__joint_trajectory__rosidl_typesupport_introspection_c__JointTrajectory_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, reno_interface, srv, JointTrajectory)() {
  if (!reno_interface__srv__detail__joint_trajectory__rosidl_typesupport_introspection_c__JointTrajectory_service_type_support_handle.typesupport_identifier) {
    reno_interface__srv__detail__joint_trajectory__rosidl_typesupport_introspection_c__JointTrajectory_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)reno_interface__srv__detail__joint_trajectory__rosidl_typesupport_introspection_c__JointTrajectory_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, reno_interface, srv, JointTrajectory_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, reno_interface, srv, JointTrajectory_Response)()->data;
  }

  return &reno_interface__srv__detail__joint_trajectory__rosidl_typesupport_introspection_c__JointTrajectory_service_type_support_handle;
}
