...
class Metaclass_JointTrajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'reno_interface.srv.JointTrajectory')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from reno_interface.srv import _joint_trajectory
...
class JointTrajectory(metaclass=Metaclass_JointTrajectory):
    from reno_interface.srv._joint_trajectory import JointTrajectory_Request as Request
    from reno_interface.srv._joint_trajectory import JointTrajectory_Response as Response
